...
- **2026-09-01 — GROK — IN PROGRESS — Mac disk/RAM pressure: resource watch + Housekeeper playbook (`grok/resource-watch`).**  Board `87e4e960`.  5-minute launchd sampler, janitor 80G/65G, housekeeper skill, live Housekeeper webhook.  Rollout: `docs/rollouts/2026-09-01-resource-watch-housekeeper.md`.
