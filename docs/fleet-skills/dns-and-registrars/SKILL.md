...
description: >-
  ...
  registrar and Cloudflare account are separate.  New DNS-only zones go on
  Usage.Jays.Services.  Use when adding a domain, linking a host, choosing a
  Cloudflare account, or touching nameservers.  Do not buy domains, mint
  accounts, or enable paid Cloudflare products without Jay.
---
