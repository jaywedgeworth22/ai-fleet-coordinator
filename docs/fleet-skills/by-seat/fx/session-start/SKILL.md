...
| ai-fleet-coordinator / machine infra | `ai-fleet-coordinator` or `fleet-infra` | AFC | `~/apps/fleet-fx` (or a `~/apps/fleet-fx-<lane>` worktree) | `~/apps/FLEET-INFRA-EFFORT-LOG.md` |
