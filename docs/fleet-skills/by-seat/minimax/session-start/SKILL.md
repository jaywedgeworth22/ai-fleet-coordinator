...
| ai-fleet-coordinator / machine infra | `ai-fleet-coordinator` or `fleet-infra` | AFC | `~/apps/fleet-minimax` (or a `~/apps/fleet-minimax-<lane>` worktree) | `~/apps/FLEET-INFRA-EFFORT-LOG.md` |
