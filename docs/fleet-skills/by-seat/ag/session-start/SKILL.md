...
| ai-fleet-coordinator / machine infra | `ai-fleet-coordinator` or `fleet-infra` | AFC | `~/apps/fleet-antigravity` (or a `~/apps/fleet-antigravity-<lane>` worktree) | `~/apps/FLEET-INFRA-EFFORT-LOG.md` |
