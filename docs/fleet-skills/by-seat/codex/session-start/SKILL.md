...
| ai-fleet-coordinator / machine infra | `ai-fleet-coordinator` or `fleet-infra` | AFC | `~/apps/fleet-codex` (or a `~/apps/fleet-codex-<lane>` worktree) | `~/apps/FLEET-INFRA-EFFORT-LOG.md` |
