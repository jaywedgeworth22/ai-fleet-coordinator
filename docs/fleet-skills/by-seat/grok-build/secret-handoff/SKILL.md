...
Load `~/.grok-build/skills/secret-safety/SKILL.md` as well when that file exists.  This skill is the fleet overlay.
...
- `~/.grok-build/skills/secret-safety/SKILL.md`
