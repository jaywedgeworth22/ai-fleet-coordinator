...
| ai-fleet-coordinator / machine infra | `ai-fleet-coordinator` or `fleet-infra` | AFC | `~/apps/fleet-grok-build` (or a `~/apps/fleet-grok-build-<lane>` worktree) | `~/apps/FLEET-INFRA-EFFORT-LOG.md` |
