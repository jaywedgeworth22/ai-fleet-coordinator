...
| ai-fleet-coordinator / machine infra | `ai-fleet-coordinator` or `fleet-infra` | AFC | `~/apps/fleet-grok` (or a `~/apps/fleet-grok-<lane>` worktree) | `~/apps/FLEET-INFRA-EFFORT-LOG.md` |
