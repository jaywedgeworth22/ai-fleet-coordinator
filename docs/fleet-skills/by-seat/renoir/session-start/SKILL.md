...
| ai-fleet-coordinator / machine infra | `ai-fleet-coordinator` or `fleet-infra` | AFL | `~/apps/fleet-renoir` (or a `~/apps/fleet-renoir-<lane>` worktree) | `~/apps/FLEET-INFRA-EFFORT-LOG.md` |
