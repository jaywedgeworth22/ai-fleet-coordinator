...
name: housekeeper
description: >-
  Mac and Hetzner disk/RAM/CPU housekeeping. Run safe cleanup scripts, CleanMyMac
  CLI, and wake BotFleet Housekeeper on resource-threshold triggers. Use when
  disk is tight, swap is high, load is elevated, the owner asks to free space,
  or the Housekeeper / GB-HOUSEKEEPER role is on duty.
---
