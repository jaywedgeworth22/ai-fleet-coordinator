...
| `~/Code/ai-fleet-coordinator/scripts/install-fleet-skills.py` | On-demand.  Specializes fleet skills per seat (Cursor, AG, Codex, Grok, Grok Build, Claude shared, Renoir, DeepSeek, Kimi retired, Desktop Monet, by-seat zips). |
