---
name: unstick-pr
description: Diagnose and repair a PR that will not merge — phantom vs real conflicts, unresolved review threads, CI dispatch misses, required-check failures, and known flakes. Use when mergeable is false, auto-merge sits idle, GitHub says CONFLICTING/BLOCKED/DIRTY, or a Cursor/peer PR is green but stuck.
---

# Unstick a blocked PR (CURSOR)
...
**Phantom fix:** merge `origin/main` in the Cursor worktree and push a fresh head SHA.
